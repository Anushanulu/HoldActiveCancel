...
import HoldActiveCancel_GB.Step00_CRB_Auth_GB_dnd;
...
//		driver = new ChromeDriver();
	...
	public void CRB_Wlcmpage() throws InterruptedException 
	{
		...
		Step00_CRB_Auth_GB_dnd login = new Step00_CRB_Auth_GB_dnd(driver);
		login.login();
	}
	@Test(priority=1)
	public void CRB_auth() 
	{
		...
		Step00_CRB_Auth_GB_dnd crbauth = new Step00_CRB_Auth_GB_dnd(driver);
		crbauth.CRB_Auth();
	}
