...
import HoldActiveCancel_GB.Step05_CreateRequestCancel_GB;
...
public class CreateRequestCancel_GB
{
	// TestNG logger
...
//		driver = new ChromeDriver();
	...
	public void RIPC_Login() throws InterruptedException, IOException 
	{
		...
		Step05_CreateRequestCancel_GB login = new Step05_CreateRequestCancel_GB(driver);
		login.login();
	}
	@Test(priority=1)
	public void cancelAction()
	{
		Step05_CreateRequestCancel_GB cancelling = new Step05_CreateRequestCancel_GB(driver);
		cancelling.cancelReq();
	}
	@Test(priority=2)
	public void reqstatus()
	{
		Step05_CreateRequestCancel_GB status = new Step05_CreateRequestCancel_GB(driver);
		status.reqStatus();
	}
