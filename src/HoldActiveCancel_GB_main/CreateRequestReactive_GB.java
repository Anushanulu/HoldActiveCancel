...
import HoldActiveCancel_GB.Step04_CreateRequestReactive_GB;
...
public class CreateRequestReactive_GB
{
	// TestNG logger
...
//		driver = new ChromeDriver();
	...
	public void RIPC_Login() throws InterruptedException, IOException 
	{
		...
		Step04_CreateRequestReactive_GB login = new Step04_CreateRequestReactive_GB(driver);
		login.login();
	}
	@Test(priority=1)
	public void reactiveAction()
	{
		Step04_CreateRequestReactive_GB reactivation = new Step04_CreateRequestReactive_GB(driver);
		reactivation.reactiveReq();
	}
	@Test(priority=2)
	public void reqstatus()
	{
		Step04_CreateRequestReactive_GB status = new Step04_CreateRequestReactive_GB(driver);
		status.reqStatus();
	}
