...
import HoldActiveCancel_GB.Step00_FinalizeAuth_GB_dnd;
...
public class FinalizeResponseAuth_GB_dnd
{
	// TestNG logger
	...
	public void login() throws InterruptedException
	{
		...
		Step00_FinalizeAuth_GB_dnd log = new Step00_FinalizeAuth_GB_dnd(driver);
		log.loginAndOpenReq();
	...
	public void Finalize()
	{
		...
		Step00_FinalizeAuth_GB_dnd respfinal = new Step00_FinalizeAuth_GB_dnd(driver);
