...
import HoldActiveCancel_GB.Step01_CreateRequestActive_GB;
...
public class CreateRequestActive_GB
{
	// TestNG logger
...
//		driver = new ChromeDriver();
	...
	public void RIPC_Login() throws InterruptedException, IOException 
	{
		...
		Step01_CreateRequestActive_GB login = new Step01_CreateRequestActive_GB(driver);
		login.login();
	}
	@Test(priority=1)
	public void Create_Req() 
	{
		...
		Step01_CreateRequestActive_GB createreq = new Step01_CreateRequestActive_GB(driver);
	...
	public void skill_Req() 
	{
		...
		Step01_CreateRequestActive_GB skillreq = new Step01_CreateRequestActive_GB(driver);
	...
	public void select_Req() 
	{
		...
		Step01_CreateRequestActive_GB selectreq = new Step01_CreateRequestActive_GB(driver);
	...
	public void req_detail() 
	{
		...
		Step01_CreateRequestActive_GB reqdetail = new Step01_CreateRequestActive_GB(driver);
	...
	public void skill_loc() 
	{
		...
		Step01_CreateRequestActive_GB skillloc = new Step01_CreateRequestActive_GB(driver);
	...
	public void alert_check() 
	{
		...
		Step01_CreateRequestActive_GB alertchk = new Step01_CreateRequestActive_GB(driver);
	...
	public void skill_price() 
	{
		...
		Step01_CreateRequestActive_GB skillprice = new Step01_CreateRequestActive_GB(driver);
	...
	public void supp() 
	{
		...
		Step01_CreateRequestActive_GB supplier = new Step01_CreateRequestActive_GB(driver);
	...
	public void reqstatus() 
	{
		...
		Step01_CreateRequestActive_GB status = new Step01_CreateRequestActive_GB(driver);
		status.reqStatus();
	}
}
