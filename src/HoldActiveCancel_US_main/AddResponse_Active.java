...
public class AddResponse_Active
{
	// TestNG logger
	...
	{
		Step02_ResponseCreation_HoldActiveCancel openreq = new Step02_ResponseCreation_HoldActiveCancel(driver); 
		openreq.reqClick();
	}
	@Test(priority=3)
 	public void create_res() throws InterruptedException, IOException 
 	{
		...
		Step02_ResponseCreation_HoldActiveCancel btnclick = new Step02_ResponseCreation_HoldActiveCancel(driver);
  ...
  @Test(priority=4)
 	public void add_Attachement() 
 	{
	  ...
	  Step02_ResponseCreation_HoldActiveCancel attachemnt = new Step02_ResponseCreation_HoldActiveCancel(driver); 
	  attachemnt.addAttachement();
 	}
  @Test(priority=5)
	public void fill_resdetails() throws IOException, InterruptedException  
	{
	  Step02_ResponseCreation_HoldActiveCancel resdetails = new Step02_ResponseCreation_HoldActiveCancel(driver); 
  ...
  @Test(priority=6)
	...
	{
	  Step02_ResponseCreation_HoldActiveCancel resattrs = new Step02_ResponseCreation_HoldActiveCancel(driver); 
	  resattrs.resAttributeDetails();
	}
  @Test(priority=7)
	public void fill_ratesdetails() throws IOException, InterruptedException  
	{
	  Step02_ResponseCreation_HoldActiveCancel rates = new Step02_ResponseCreation_HoldActiveCancel(driver); 
	  rates.resRates("20","20");
	}
  @Test(priority=8)
	public void save_Form() throws IOException, InterruptedException  
	{
	  Step02_ResponseCreation_HoldActiveCancel save = new Step02_ResponseCreation_HoldActiveCancel(driver); 
	  save.saveForm();
	}
  @Test(priority=9)
