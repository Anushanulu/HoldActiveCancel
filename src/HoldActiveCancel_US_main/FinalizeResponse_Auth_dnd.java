...
import HoldActiveCancel_US.Step00_Finalize_Auth_dnd;
...
public class FinalizeResponse_Auth_dnd
{
	// TestNG logger
	...
	public void login() throws InterruptedException
	{
		...
		Step00_Finalize_Auth_dnd log = new Step00_Finalize_Auth_dnd(driver);
		log.loginAndOpenReq();
	...
	public void Finalize()
	{
		...
		Step00_Finalize_Auth_dnd respfinal = new Step00_Finalize_Auth_dnd(driver);
