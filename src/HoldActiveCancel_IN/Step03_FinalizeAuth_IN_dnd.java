...
public class Step03_FinalizeAuth_IN_dnd {
...
public Step03_FinalizeAuth_IN_dnd(WebDriver driver)
{
	this.driver=driver;
...
//	Rog.selectByVisibleText(RO);
	...
	Step03_FinalizeAuth_IN_dnd popup = new Step03_FinalizeAuth_IN_dnd(driver);
