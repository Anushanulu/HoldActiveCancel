...
public class Step04_CRB_Auth_IN_dnd {
...
@FindBy (xpath = ".//*[@id='content-main']/form[1]/div/span/input") private WebElement Create_New_Request;
	...
	public Step04_CRB_Auth_IN_dnd(WebDriver driver)
	{
		this.driver=driver;
	...
	//switch instance
			public void switch_instance()
			{
				...
				wait03.until(ExpectedConditions.visibilityOf(Instance));
				Select cntry = new Select(Instance);
				//cntry.selectByVisibleText("  Asia/Pacific");	
				cntry.selectByValue("IBMCSAC03");
				GO.click();
			}
    ...
    public void crb_auth()
    {
		...
		wait08.until(ExpectedConditions.visibilityOf(Auth_Selected_Button)); 
