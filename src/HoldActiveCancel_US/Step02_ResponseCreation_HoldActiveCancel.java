...
public class Step02_ResponseCreation_HoldActiveCancel {
...
//		@FindBy (xpath= "//mat-calendar[contains(@id,'mat-datepicker')]/div/mat-month-view/table/tbody/tr[4]/td[5]") private WebElement enddt_Calender;
	...
	//Status of Rasponse
		@FindBy (xpath = "  //*[contains(text(),'Dashboard ')]") private WebElement dashboard;	
		@FindBy (xpath = "  //*[contains(@class,'mat-cell cdk-column-status')]") private WebElement Status;	
		//@FindBy (xpath = "//*[contains(@class,'content-text ng-star-inserted') and contains(text(),'Active')]") private WebElement Active_Status;
		@FindBy (xpath = "//button[@ibmbutton='secondary' and contains(text(),'Exit')]") private WebElement Exit_Button;
		//@FindBy (xpath = ".//*[@class='bx--btn bx--btn--secondary bx--btn--sm']") private WebElement Exit_Button;
		...
		public Step02_ResponseCreation_HoldActiveCancel(WebDriver driver)
		{
			this.driver=driver;
		...
		public void reqClick() throws InterruptedException
		{
...
//			wait13.until(ExpectedConditions.visibilityOf(enddt_Calender));
		...
		/*	AcceptAgrement.click();
			...
			wait19.until(ExpectedConditions.visibilityOf(Submit_btn));
			Thread.sleep(5000);
			JavascriptExecutor js = (JavascriptExecutor)driver;
			js.executeScript("arguments[0].click();", Submit_btn);
			WebDriverWait wait20 = new WebDriverWait(driver, 160);
			wait20.until(ExpectedConditions.visibilityOf(confirm_submit));
			confirm_submit.click();
			
			WebDriverWait wait21 = new WebDriverWait(driver, 160);
			wait21.until(ExpectedConditions.elementToBeClickable(Exit_Button));
			//Exit_Button.click();
			
			JavascriptExecutor js1 = (JavascriptExecutor)driver;
			js1.executeScript("arguments[0].click();", Exit_Button);
			
			/*WebDriverWait wait21 = new WebDriverWait(driver, 160);
			wait21.until(ExpectedConditions.elementToBeClickable(dashboard));
			dashboard.click();
			openRequest();*/
		...
		public void resStatus(String expected)
		{
			Assert.assertEquals(expected, Status.getText());
		}
