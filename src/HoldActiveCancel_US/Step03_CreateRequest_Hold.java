...
public class Step03_CreateRequest_Hold {
	...
	public Step03_CreateRequest_Hold(WebDriver driver)
	{
		this.driver=driver;
...
//		loginToContractor_Link.click();
	...
	public void holdReq()
	{
		...
		wait08.until(ExpectedConditions.visibilityOf(Holdskill_btn));
		Holdskill_btn.click();
		
		WebDriverWait wait09 = new WebDriverWait(driver, 160);
		wait09.until(ExpectedConditions.visibilityOf(Hold_Reason));
