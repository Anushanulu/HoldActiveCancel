...
public class Step00_Finalize_Auth_dnd {
...
public Step00_Finalize_Auth_dnd(WebDriver driver)
{
	this.driver=driver;
...
public void FinaliseSubmit()
{
	...
	Step00_Finalize_Auth_dnd popup = new Step00_Finalize_Auth_dnd(driver);
