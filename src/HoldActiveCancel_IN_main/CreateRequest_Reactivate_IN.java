...
import HoldActiveCancel_IN.Step04_CreateRequest_Reactivate_IN;
...
public class CreateRequest_Reactivate_IN
{
	// TestNG logger
...
//		driver = new ChromeDriver();
	...
	public void RIPC_Login() throws InterruptedException 
	{
		...
		Step04_CreateRequest_Reactivate_IN login = new Step04_CreateRequest_Reactivate_IN(driver);
		login.login();
	...
	{
		Step04_CreateRequest_Reactivate_IN reactivation = new Step04_CreateRequest_Reactivate_IN(driver);
	...
	{
		Step04_CreateRequest_Reactivate_IN status = new Step04_CreateRequest_Reactivate_IN(driver);
		status.reqStatus();
	}
