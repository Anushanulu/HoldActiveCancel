...
import HoldActiveCancel_IN.Step03_FinalizeAuth_IN_dnd;
...
public class FinalizeResponseAuth_IN_dnd
{
	// TestNG logger
	...
	public void login() throws InterruptedException
	{
		...
		Step03_FinalizeAuth_IN_dnd log = new Step03_FinalizeAuth_IN_dnd(driver);
		log.loginAndOpenReq();
	...
	public void Finalize()
	{
		...
		Step03_FinalizeAuth_IN_dnd respfinal = new Step03_FinalizeAuth_IN_dnd(driver);
