...
import HoldActiveCancel_IN.Step05_CreateRequest_Cancel_IN;
...
public class CreateRequest_Cancel_IN
{
	// TestNG logger
...
//		driver = new ChromeDriver();
	...
	public void RIPC_Login() throws InterruptedException 
	{
		...
		Step05_CreateRequest_Cancel_IN login = new Step05_CreateRequest_Cancel_IN(driver);
		login.login();
	...
	{
		Step05_CreateRequest_Cancel_IN cancelling = new Step05_CreateRequest_Cancel_IN(driver);
		cancelling.cancelReq();
	}
	@Test(priority=2)
	public void reqstatus()
	{
		Step05_CreateRequest_Cancel_IN status = new Step05_CreateRequest_Cancel_IN(driver);
		status.reqStatus();
	}
