...
import HoldActiveCancel_IN.Step04_CRB_Auth_IN_dnd;
...
//		driver = new ChromeDriver();
	...
	public void CRB_Wlcmpage() throws InterruptedException 
	{
		...
		Step04_CRB_Auth_IN_dnd crblogin = new Step04_CRB_Auth_IN_dnd(driver);
		crblogin.login();
		crblogin.switch_instance();
	}
	...
	public void CRB_auth() 
	{
		...
		Step04_CRB_Auth_IN_dnd auth = new Step04_CRB_Auth_IN_dnd(driver);
		auth.crb_auth();
	}
