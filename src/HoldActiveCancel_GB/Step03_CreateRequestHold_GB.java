...
public class Step03_CreateRequestHold_GB {
...
//Hold Action
	@FindBy ( xpath="//input[@value='Hold Skill(s)']") private WebElement Holdskill_btn ;
	@FindBy ( xpath= "//*[@id='TBLCOL_REASON~0']") private WebElement Hold_Reason;
...
public Step03_CreateRequestHold_GB(WebDriver driver)
{
	this.driver=driver;
...
public void holdReq()
{
	...
	wait06.until(ExpectedConditions.visibilityOf(Holdskill_btn));
	Holdskill_btn.click();
	
	WebDriverWait wait07 = new WebDriverWait(driver, 160);
	wait07.until(ExpectedConditions.visibilityOf(Hold_Reason));
	Select reasonList = new Select(Hold_Reason);
	reasonList.selectByValue("CCSN");
	//driver.manage().timeouts().implicitlyWait(6, TimeUnit.SECONDS);
	
	WebDriverWait wait08 = new WebDriverWait(driver, 180);
	wait08.until(ExpectedConditions.visibilityOf(comments));
	comments.sendKeys("Hold the candidate");
	
	WebDriverWait wait09 = new WebDriverWait(driver, 180);
	wait09.until(ExpectedConditions.visibilityOf(saveAndContinue));
...
public void reqStatus()
{
	...
	wait10.until(ExpectedConditions.visibilityOf(LHS_Search_tab));
	LHS_Search_tab.click();

	WebDriverWait wait11 = new WebDriverWait(driver, 160);
	wait11.until(ExpectedConditions.visibilityOf(Request_Num_Fld)); 
	Request_Num_Fld.sendKeys(Excel.getCellValue(xlsFilePath, "Request_creation", 2, 15));
	Search_GO_btn.click();

	
	WebDriverWait wait12 = new WebDriverWait(driver, 160);
	wait12.until(ExpectedConditions.visibilityOf(Req_status)); 
	String strExpected = "On hold";
