...
public class Step00_FinalizeAuth_GB_dnd {
...
public Step00_FinalizeAuth_GB_dnd(WebDriver driver)
{
	this.driver=driver;
...
public void FinaliseSubmit()
{
	...
	Step00_FinalizeAuth_GB_dnd popup = new Step00_FinalizeAuth_GB_dnd(driver);
