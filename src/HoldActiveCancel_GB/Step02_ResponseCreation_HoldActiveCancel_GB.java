...
public class Step02_ResponseCreation_HoldActiveCancel_GB {
...
//		@FindBy (xpath= "//mat-calendar[contains(@id,'mat-datepicker')]/div/mat-month-view/table/tbody/tr[4]/td[5]") private WebElement enddt_Calender;
	...
	//Status of Rasponse
		//@FindBy (xpath = "//span[@class='ng-star-inserted' and contains(text(),'Active')]") private WebElement Status_Active;
		@FindBy (xpath = "  //*[contains(@class,'mat-cell cdk-column-status')]") private WebElement Status;	
		@FindBy (xpath = "//*[contains(text(),'Exit')]") private WebElement Exit_Button;
		
		
		// Initialize the web elements 
		public Step02_ResponseCreation_HoldActiveCancel_GB(WebDriver driver)
		{
			this.driver=driver;
...
//			driver.switchTo().alert().accept();
			...
			wait21.until(ExpectedConditions.visibilityOf(Exit_Button));
